...
def load_disfl_qa_data(filepath):
    ...
    Args:
        filepath (str): The path to the train.json or dev.json file.
...
# Adjust these paths based on where your train.json and dev.json are located
train_filepath = 'data/train.json' 
dev_filepath = 'data/dev.json'     

# Ensure the data directory exists
if not os.path.exists('data'):
    print("Error: 'data' directory not found. Please create it and place train.json/dev.json inside.")
    exit()

print(f"Loading training data from: {train_filepath}")
train_data_list = load_disfl_qa_data(train_filepath)

print(f"Loading validation data from: {dev_filepath}")
eval_data_list = load_disfl_qa_data(dev_filepath)
