...
# Based on your prompt, it's "./model/flan_t5/final_model"
final_model_path = "./model/t5/final_model"
# to load the model directly from huggingface.co, you can use:
# final_model_path = "galmieux/t5_disfl_qa"
...
test_disfluent_question = "correct disfluency: um, what is the, uh, capital of France?" # Update the question accordingly
...
if torch.cuda.is_available():
    loaded_model.to("cuda") # Ensure model is on GPU
    input_ids = input_ids.to("cuda")

generated_ids = loaded_model.generate(input_ids, max_new_tokens=MAX_TARGET_LENGTH)
generated_text = loaded_tokenizer.decode(generated_ids[0], skip_special_tokens=True)
